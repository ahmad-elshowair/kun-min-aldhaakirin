...
const DhikrCounter: FC<IDhikrCounterProps> = ({ maxCount }) => {
  ...
  const waveFill = (count / safeMax) * 100;

  return (
    <div
      role="button"
      aria-label={`Dhikr counter: ${count} of ${maxCount ?? 1}`}
        ...
        >
          ...
          >
            <path
              ...
              d="M0,160L48,165.3C96,171,192,181,288,176C384,171,480,149,576,149.3C672,149,768,171,864,160C960,149,1056,107,1152,101.3C1248,96,1344,128,1392,144L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
            ></path>
          </svg>
        </div>
      </div>
